      ...
      <div className="grid-container">
        <div className="header">
          <div className="upper-nav">
            ...
            <div className="email">Email: sales@thanhtin-tech.com</div>
            <div className="lang">
              <button>
          ...
          <nav>
            ...
            <div className="cart">
              ...
              <div className="quantity">Giỏ hàng: 0</div>
            </div>
          </nav>
        </div>
        ...
        <div className="footer">
          <div className="footer-child contact">
            ...
            <div className="footer-child vphcm">
            ...
            <div className="footer-child vphn">
          ...
          <div className="footer-child pkinhdoanh">
          ...
          <div className="footer-child pkythuat">
          ...
          <div className="footer-child social-contact">
